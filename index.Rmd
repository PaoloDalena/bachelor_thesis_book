...
github-repo: PaoloDalena/bachelor_thesis_book
...
You can find the link to the Github page of my workflow (with all the R scripts useful for the analysis and for creating the provided graphs) [here](https://github.com/PaoloDalena/tesi) and the official published documents [here](https://github.com/PaoloDalena/tesi/tree/master/Tesi_docs).  
